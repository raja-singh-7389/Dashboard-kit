...
# Load the image
try:
    image = Image.open("a9109b00-26b3-4532-852f-169e62861ac8.jpg")
except FileNotFoundError:
    st.warning("Image not found. Using placeholder image.")
    image = Image.open("https://via.placeholder.com/300")  # Placeholder image URL
